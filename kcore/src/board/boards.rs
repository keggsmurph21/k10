...
pub mod standard {
    ...
    pub fn nodes<R: Rng>(mut rng: &mut R) -> Nodes {
        ...
        let make_road = |x: u16, y: u16, orientation: RoadOrientation| -> Option<Node> {
            Some(Node::Road(Road::new(Index::new(x, y), orientation)))
        };
        ...
        nodes[2][7] = make_road(2, 7, RoadOrientation::ForwardSlash);
        nodes[2][9] = make_road(2, 9, RoadOrientation::BackSlash);
        nodes[2][11] = make_road(2, 11, RoadOrientation::ForwardSlash);
        nodes[2][13] = make_road(2, 13, RoadOrientation::BackSlash);
        nodes[2][15] = make_road(2, 15, RoadOrientation::ForwardSlash);
        nodes[2][17] = make_road(2, 17, RoadOrientation::BackSlash);
        ...
        nodes[4][6] = make_road(4, 6, RoadOrientation::Pipe);
        nodes[4][8] = make_hex(4, 8, false);
        nodes[4][10] = make_road(4, 10, RoadOrientation::Pipe);
        nodes[4][12] = make_hex(4, 12, false);
        nodes[4][14] = make_road(4, 14, RoadOrientation::Pipe);
        nodes[4][16] = make_hex(4, 16, false);
        nodes[4][18] = make_road(4, 18, RoadOrientation::Pipe);
        ...
        nodes[6][5] = make_road(6, 5, RoadOrientation::ForwardSlash);
        nodes[6][7] = make_road(6, 7, RoadOrientation::BackSlash);
        nodes[6][9] = make_road(6, 9, RoadOrientation::ForwardSlash);
        nodes[6][11] = make_road(6, 11, RoadOrientation::BackSlash);
        nodes[6][13] = make_road(6, 13, RoadOrientation::ForwardSlash);
        nodes[6][15] = make_road(6, 15, RoadOrientation::BackSlash);
        nodes[6][13] = make_road(6, 13, RoadOrientation::ForwardSlash);
        nodes[6][15] = make_road(6, 15, RoadOrientation::BackSlash);
        nodes[6][17] = make_road(6, 17, RoadOrientation::ForwardSlash);
        nodes[6][19] = make_road(6, 19, RoadOrientation::BackSlash);
        ...
        nodes[8][4] = make_road(8, 4, RoadOrientation::Pipe);
        nodes[8][6] = make_hex(8, 6, false);
        nodes[8][8] = make_road(8, 8, RoadOrientation::Pipe);
        nodes[8][10] = make_hex(8, 10, false);
        nodes[8][12] = make_road(8, 12, RoadOrientation::Pipe);
        nodes[8][14] = make_hex(8, 14, false);
        nodes[8][16] = make_road(8, 16, RoadOrientation::Pipe);
        nodes[8][18] = make_hex(8, 18, false);
        nodes[8][20] = make_road(8, 20, RoadOrientation::Pipe);
        ...
        nodes[10][3] = make_road(10, 3, RoadOrientation::ForwardSlash);
        nodes[10][5] = make_road(10, 5, RoadOrientation::BackSlash);
        nodes[10][7] = make_road(10, 7, RoadOrientation::ForwardSlash);
        nodes[10][9] = make_road(10, 9, RoadOrientation::BackSlash);
        nodes[10][11] = make_road(10, 11, RoadOrientation::ForwardSlash);
        nodes[10][13] = make_road(10, 13, RoadOrientation::BackSlash);
        nodes[10][11] = make_road(10, 11, RoadOrientation::ForwardSlash);
        nodes[10][13] = make_road(10, 13, RoadOrientation::BackSlash);
        nodes[10][15] = make_road(10, 15, RoadOrientation::ForwardSlash);
        nodes[10][17] = make_road(10, 17, RoadOrientation::BackSlash);
        nodes[10][19] = make_road(10, 19, RoadOrientation::ForwardSlash);
        nodes[10][21] = make_road(10, 21, RoadOrientation::BackSlash);
        ...
        nodes[12][2] = make_road(12, 2, RoadOrientation::Pipe);
        nodes[12][4] = make_hex(12, 4, false);
        nodes[12][6] = make_road(12, 6, RoadOrientation::Pipe);
        nodes[12][8] = make_hex(12, 8, false);
        nodes[12][10] = make_road(12, 10, RoadOrientation::Pipe);
        nodes[12][12] = make_hex(12, 12, false);
        nodes[12][14] = make_road(12, 14, RoadOrientation::Pipe);
        nodes[12][16] = make_hex(12, 16, false);
        nodes[12][18] = make_road(12, 18, RoadOrientation::Pipe);
        nodes[12][20] = make_hex(12, 20, false);
        nodes[12][22] = make_road(12, 22, RoadOrientation::Pipe);
        ...
        nodes[14][3] = make_road(14, 3, RoadOrientation::BackSlash);
        nodes[14][5] = make_road(14, 5, RoadOrientation::ForwardSlash);
        nodes[14][7] = make_road(14, 7, RoadOrientation::BackSlash);
        nodes[14][9] = make_road(14, 9, RoadOrientation::ForwardSlash);
        nodes[14][11] = make_road(14, 11, RoadOrientation::BackSlash);
        nodes[14][13] = make_road(14, 13, RoadOrientation::ForwardSlash);
        nodes[14][11] = make_road(14, 11, RoadOrientation::BackSlash);
        nodes[14][13] = make_road(14, 13, RoadOrientation::ForwardSlash);
        nodes[14][15] = make_road(14, 15, RoadOrientation::BackSlash);
        nodes[14][17] = make_road(14, 17, RoadOrientation::ForwardSlash);
        nodes[14][19] = make_road(14, 19, RoadOrientation::BackSlash);
        nodes[14][21] = make_road(14, 21, RoadOrientation::ForwardSlash);
        ...
        nodes[16][4] = make_road(16, 4, RoadOrientation::Pipe);
        nodes[16][6] = make_hex(16, 6, false);
        nodes[16][8] = make_road(16, 8, RoadOrientation::Pipe);
        nodes[16][10] = make_hex(16, 10, false);
        nodes[16][12] = make_road(16, 12, RoadOrientation::Pipe);
        nodes[16][14] = make_hex(16, 14, false);
        nodes[16][16] = make_road(16, 16, RoadOrientation::Pipe);
        nodes[16][18] = make_hex(16, 18, false);
        nodes[16][20] = make_road(16, 20, RoadOrientation::Pipe);
        ...
        nodes[18][5] = make_road(18, 5, RoadOrientation::BackSlash);
        nodes[18][7] = make_road(18, 7, RoadOrientation::ForwardSlash);
        nodes[18][9] = make_road(18, 9, RoadOrientation::BackSlash);
        nodes[18][11] = make_road(18, 11, RoadOrientation::ForwardSlash);
        nodes[18][13] = make_road(18, 13, RoadOrientation::BackSlash);
        nodes[18][15] = make_road(18, 15, RoadOrientation::ForwardSlash);
        nodes[18][13] = make_road(18, 13, RoadOrientation::BackSlash);
        nodes[18][15] = make_road(18, 15, RoadOrientation::ForwardSlash);
        nodes[18][17] = make_road(18, 17, RoadOrientation::BackSlash);
        nodes[18][19] = make_road(18, 19, RoadOrientation::ForwardSlash);
        ...
        nodes[20][6] = make_road(20, 6, RoadOrientation::Pipe);
        nodes[20][8] = make_hex(20, 8, false);
        nodes[20][10] = make_road(20, 10, RoadOrientation::Pipe);
        nodes[20][12] = make_hex(20, 12, false);
        nodes[20][14] = make_road(20, 14, RoadOrientation::Pipe);
        nodes[20][16] = make_hex(20, 16, false);
        nodes[20][18] = make_road(20, 18, RoadOrientation::Pipe);
        ...
        nodes[22][7] = make_road(22, 7, RoadOrientation::BackSlash);
        nodes[22][9] = make_road(22, 9, RoadOrientation::ForwardSlash);
        nodes[22][11] = make_road(22, 11, RoadOrientation::BackSlash);
        nodes[22][13] = make_road(22, 13, RoadOrientation::ForwardSlash);
        nodes[22][15] = make_road(22, 15, RoadOrientation::BackSlash);
        nodes[22][17] = make_road(22, 17, RoadOrientation::ForwardSlash);
